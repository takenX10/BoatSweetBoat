...
<section
  ...
  <div class="text-center p-4" id="copyright">
    © 2021 Copyright: 
    <a class="text-reset fw-bold" href="https://mdbootstrap.com/">MDBootstrap.com</a> <br />
    Designed by <a class="text-reset fw-bold" href="https://github.com/takenX10"  alt="">takenX10</a> and <a class="text-reset fw-bold" href="https://github.com/https://github.com/VittoriaFrau" alt="">VittoriaFrau</a>
    ...
    <div>
      ...
      <a href="" class="me-4 text-reset">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset hoverLinks">Angular</a>
          </p>
          <p>
